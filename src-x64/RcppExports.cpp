...
RcppExport SEXP _MDC_matrixCalcFastTwo(SEXP matrixOneSEXP, SEXP multTimesSEXP, SEXP matrixOfDiagSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_MDC_matrixCalcFastTwo", (DL_FUNC) &_MDC_matrixCalcFastTwo, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_MDC(DllInfo *dll) {
